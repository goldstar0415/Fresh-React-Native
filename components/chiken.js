...
var ChikenComponent = React.createClass({
    ...
    return (
	 ...
	 <View style={styles.container}>
		...
		<View style={{ flex: .10, backgroundColor: '#FFF',flexDirection: 'row',}}>
		 ...
		 <View style={{ flex: .10, backgroundColor: '#FFF',flexDirection: 'row',borderColor:'#f47239',
		borderTopWidth:1}}>
		  <View style={{flex:.35,  justifyContent: 'center',alignItems: 'center',flexDirection: 'row',}}>
...
AppRegistry.registerComponent('ChikenComponent', () => ChikenComponent);
module.exports = ChikenComponent;
